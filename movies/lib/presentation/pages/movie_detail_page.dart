...
class DetailContent extends StatelessWidget {
  ...
  const DetailContent(this.movieDetail, this.recommendations, this.isAddedWatchlist, {super.key});
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () async {
                                if (!isAddedWatchlist) {
                                  ...
                                  context
                                      .read<DetailMovieBloc>()
                                      .add(RemoveFromWatchlistMovie(movieDetail));
                                }
                              },
                              child: Row(
                            ...
                            BlocBuilder<DetailMovieBloc, DetailMovieState>(
                              builder: (context, state) {
                                final recommendationState = state.movieRecommendationsState;
